...
E131Dialog::E131Dialog(wxWindow* parent,const wxString& title)
{
	...
	TextCtrlIpAddr = new wxTextCtrl(this, ID_TEXTCTRL_IP_ADDR, _("239.255.0.1"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL_IP_ADDR"));
	...
	FlexGridSizer2->Add(SpinCtrl_StartUniv, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer2->Add(SpinCtrl_NumUniv, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
{
    TextCtrlIpAddr->SetValue(_("239.255.0.1"));
