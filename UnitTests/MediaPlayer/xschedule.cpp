...
bool wxMediaPlayerApp::OnInit()
{
    ...
    wxMediaPlayerFrame *frame =
        new wxMediaPlayerFrame(wxT("xSchedule"));
    frame->Show(true);
...
void wxMediaPlayerFrame::OnAbout(wxCommandEvent& WXUNUSED(event))
{
    ...
    msg.Printf( wxT("xSchedule\n\n")
                ...
                wxT("The lower slider controls the volume\n\n")
...
void wxMediaPlayerTimer::Notify()
{
    ...
    if(currentpage)
    {
        ...
        // Setup the slider min/max values
